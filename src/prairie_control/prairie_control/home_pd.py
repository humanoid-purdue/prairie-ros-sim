...
class home_pd(Node):
    def __init__(self):
        ...
        self.p_gains = np.array([50, 40, 40, 50, 50, 40, 
                                 50, 40, 40, 50, 50, 40.,
                                 10., 10., 10.,
                                 10., 10., 10.])
    ...
    def stand_pd(self):
        ...
        jtp_ankle_pd = self.lin_acc[0] * -0.0# + self.lin_vel[0] * -3.0
        #jtp_ankle_pd = 0.0

        tau_delta = self.ff_torque
    ...
    def walk_gz(self):
        ...
        if self.state_time < 0.0:
            ...
            pos = self.wpn.apply_net(self.joint_pos,
                               self.joint_vel,
                               self.ang_vel,
                               self.lin_acc,
                               self.cmd_vel,
